    ...
    (set, get) => ({
      ...
      loadFromInvoice: (invoice: Invoice, id: number) => {
        ...
        return set({
          ...
          notes: invoice.notes ?? "",
          paymentMethod: (invoice.paymentMethod as PaymentMethodType) || "momo",
          momoProvider: (invoice.momoProvider as MomoProvider) || "mtn",
          momoAccountName: invoice.momoAccountName ?? "",
          momoNumber: invoice.momoNumber ?? "",
          momoCountryCode: invoice.momoCountryCode ?? "GH",
