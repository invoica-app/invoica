    ...
    <>
      ...
      >
        ...
        <Link
          ...
          className={cn(
            "flex items-center justify-center gap-2 mb-4 rounded-lg border border-border text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-accent/50 transition-colors",
            expanded ? "px-4 py-2" : "py-2"
          )}
          title={collapsed ? "Back to app" : undefined}
        >
          <ArrowLeft className="w-4 h-4 shrink-0" />
          {expanded && "Back to app"}
        </Link>
